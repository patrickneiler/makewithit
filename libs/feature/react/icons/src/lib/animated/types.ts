import type {
  ...
  export interface AnimationLayer extends AnimationData {
    nm: string,
    refId?: string;
  }
  ...
  export type AnimatedIconCategoryType = (icon?: string) => {
    names: Names;
    icon?: AnimatedIconType;
    icons: Partial<AnimatedIconType>[]
  };
  export type AnimatedIconCategoriesType = (category?: string) => AnimatedIconCategoryType[] | undefined;