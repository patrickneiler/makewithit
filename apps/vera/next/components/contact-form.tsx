            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        <h1 className="h1 font-red-hat-display mb-4">Sign up for early access!</h1>
                    ...
                    <form className="max-w-xl mx-auto">
                        <div className="flex flex-wrap -mx-3 mb-5">
                            <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                ...
                                <input id="first-name" type="text" className="form-input w-full" placeholder="Enter your first name" />
                            </div>
                            <div className="w-full md:w-1/2 px-3">
                                ...
                                <input id="last-name" type="text" className="form-input w-full" placeholder="Enter your last name" />
                            </div>
                        </div>
                        <div className="flex flex-wrap -mx-3 mb-5">
                            <div className="w-full px-3">
                                <div className="flex justify-between items-center mb-1">
                                    <label className="block text-gray-800 dark:text-gray-300 text-sm font-medium" htmlFor="message">Email</label>
                        ...
                        <div className="flex flex-wrap -mx-3 mb-5">
                            <div className="w-full px-3">
                                ...
                                <textarea id="message" rows={4} className="form-textarea w-full" placeholder="What interests you in Vera?" required></textarea>
                            </div>
                        </div>
