...
import { IconArrowElbow, IconExternalLink, IconPlus } from './ui/icons'
import { Session } from 'next-auth'

export interface PromptProps
  extends Pick<UseChatHelpers, 'input' | 'setInput' | 'messages'> {
  ...
  return (
    (
      <form
        ...
        ref={formRef}
      >
        <div className="relative border-0 flex max-h-60 w-full grow flex-col overflow-hidden bg-background px-8 pl-0  sm:rounded-md sm:x-12">
          {/* <Tooltip>
