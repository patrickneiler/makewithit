        ...
        try {
            const options = {
                ...
                body: JSON.stringify({
                    ...
                    source_url: 'https://firebasestorage.googleapis.com/v0/b/make-with-it-firebase.appspot.com/o/model.JPG?alt=media&token=723d6ae5-8003-474c-b1cb-8ec931e74a83'
                })
            };
