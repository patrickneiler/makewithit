    ...
    return (
        <div onClick={() => changeMute()}>
            <div className='flex align-center items-start -ml-16'>
                <Button className={`h-16 w-16 flex align-center justify-center p-0 rounded-full scale-75 md:scale-100 ${muted ? 'text-teal-800' : 'text-teal-500 hover:text-teal-500 hover:bg-gray-500'}`} variant="ghost" >
                ...
                <div className={`${isLoading && 'video-loading'} clone-video rounded-full relative p-1 drop-shadow`}>
                    <div className={`relative rounded-full overflow-hidden  h-36 w-36  md:h-48 md:w-48 xl:h-[256px] xl:w-[256px] shadow-inner `}>
