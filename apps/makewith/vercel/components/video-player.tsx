    ...
    return (
        <div onClick={() => changeMute()}>
            <div className='flex align-center items-start -ml-16'>
                <Button className={`h-16 w-16 flex align-center justify-center p-0 rounded-full scale-75 md:scale-100 ${muted ? 'text-teal-800' : 'text-teal-500 hover:text-teal-500'}`} variant="ghost" >
